...
import { ResumeType, EducationLevelType } from '@/modules/resume'
import { FormInstance, UploadFile } from 'element-plus'
import type { AreaType } from '@/types/area.type'
import { EDUCATION_LEVELS } from '@/modules/editResume/constants/constants'
import type { CompanyType } from '@/modules/editResume/types/company.type'
import { getAllAreas } from '@/helpers/area.helper'
import { getAllCompanies } from '@/modules/editResume/helpers/company.helper'
import { getSkillType } from '@/modules/editResume/helpers/skills.helper'
import { resumeApi } from '@/api/resume.api'
import { editResume, saveAvatar } from '@/modules/editResume/helpers/resumeEdition.hepler'
